An example implementation of a metric analyzer which can reused. Few trivial operations are shown to demonstrate but users can define their custom operation in metric class. 
